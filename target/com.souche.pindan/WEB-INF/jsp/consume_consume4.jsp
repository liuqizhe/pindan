...
-->
  <script type="text/javascript">
    ...
    function changePage(page) {
      document.consInfo.action="/pindan/consume/changePage.from?page="+page ;
      document.consInfo.submit() ;
    }

    function commit2() {
      document.consInfo.action="/pindan/consume/consume.from" ;
      document.consInfo.submit() ;
    }
  </script>
          ...
          <div id="pages">
            <c:choose>
              <c:when test="${page.page>1}">
                <a onclick="changePage(${page.page-1})">上一页</a>
              </c:when>
            ...
            <c:choose>
              <c:when test="${page.page<page.totalPage}">
                <a onclick="changePage(${page.page+1})">下一页</a>
              </c:when>
